...
export function ImageLoader(props: Parameters<typeof Image>[0]) {
  ...
  return (
    <div className="relative border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden bg-zinc-100 dark:bg-zinc-900 inline-block shadow-sm min-w-75 min-h-37.5">
      {isLoading && (
